...
pub struct HostModelRequest {
    ...
    #[serde(default)]
    pub ordered_tool_results: Vec<HostToolResult>,
...
impl HostCommandPayload {
    ...
    pub fn generation_v2(request: HostModelRequest) -> Self {
        ...
        payload.ordered_tool_results = request.ordered_tool_results;
    ...
    pub fn model_request_v2(
        ...
        Ok(HostModelRequest {
            ...
            ordered_tool_results: self.ordered_tool_results.clone(),
            purpose: self
    ...
    pub fn validate_for(
        ...
        let generation_body_is_empty = self.system_prompt.is_none()
            ...
            && self.ordered_tool_results.is_empty()
