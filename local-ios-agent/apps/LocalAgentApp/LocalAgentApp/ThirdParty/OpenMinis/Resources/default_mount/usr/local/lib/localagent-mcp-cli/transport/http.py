...
#
#     /var/localagent/mcp-servers/oauth/<server>.json
...
OAUTH_DIR = "/var/localagent/mcp-servers/oauth"
...
def _authorize_deeplink(server_name):
    ...
    return "[Authorize](localagent://settings/mcp-servers/%s)" % quote(server_name, safe="")
