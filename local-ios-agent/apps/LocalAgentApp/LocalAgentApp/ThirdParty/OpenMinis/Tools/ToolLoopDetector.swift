...
private struct ToolLoopLog {
    func error(_ message: String) {
        NSLog("[ToolLoopDetector] ERROR: %@", message)
    }

    func warning(_ message: String) {
        NSLog("[ToolLoopDetector] WARNING: %@", message)
    }
}

private let logger = ToolLoopLog()
...
final class ToolLoopDetector: @unchecked Sendable {
